...
If we don't want to see the output from the column specification, we can hide this using the `show_col_types = FALSE` argument: 
...
`readxl` comes with three functions for reading Excel data: `readxl::read_excel()`, `readxl::read_xls()`, and `readxl::read_xlxs()`
