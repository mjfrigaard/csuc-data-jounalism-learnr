...
knitr::include_graphics(path = "https://raw.githubusercontent.com/mjfrigaard/csuc-data-jounalism-learnr/main/cheatsheets/rscs-01-import/img/import-readr-gui-path.png")
```
...
knitr::include_graphics(path = "https://raw.githubusercontent.com/mjfrigaard/csuc-data-jounalism-learnr/main/cheatsheets/rscs-01-import/img/import-readr-gui-options.png")
```
...
knitr::include_graphics(path = "https://raw.githubusercontent.com/mjfrigaard/csuc-data-jounalism-learnr/main/cheatsheets/rscs-01-import/img/import-readr-gui-code.png")
```
...
knitr::include_graphics(path = "https://raw.githubusercontent.com/mjfrigaard/csuc-data-jounalism-learnr/main/cheatsheets/rscs-01-import/img/import-readr-gui-options-alt.png")
```
...
knitr::include_graphics(path = "https://raw.githubusercontent.com/mjfrigaard/csuc-data-jounalism-learnr/main/cheatsheets/rscs-01-import/img/import-readr-gui-code-alt.png")
```
...
The data in this section are available at this [link](https://github.com/mjfrigaard/csuc-data-jounalism-learnr/raw/main/cheatsheets/rscs-01-import/data/readxl/readxl-data.xlsx). 
...
If we want to import a sheet from the `readxl-data.xlsx` file, Position is numeric, with `1` being the first sheet. 
...
You can also provide the name of the sheet (from `excel_sheets()` above).
