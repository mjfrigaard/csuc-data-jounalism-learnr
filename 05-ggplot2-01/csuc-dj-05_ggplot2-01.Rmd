...
We've looked at the relationship between movie length and average IMDB rating, and there doesn't seem to be a strong relationship. If there had been, the points would look like 

```{r rnorm_multi}
CorrData <- rnorm_multi(n = 100, 
                        mu = c(0, 20, 20),
                        sd = c(1, 5, 5),
                        r = c(0.5, 0.5, 0.25), 
                        varnames = c("A", "B", "C"),
